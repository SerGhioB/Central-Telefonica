...
namespace CentralTelefonica
{
    class Program
    {
        ...
        {
            /*En estas instancias se crea el objeto llamdaDepto de
            tipo Llamda, por lo que las propiedades Franja, etc 
            set tienen que castear al tipo LlamadaDepartamental*/
            ...
            ((LlamadaLocal)otraLocal).Precio = 0.95;
